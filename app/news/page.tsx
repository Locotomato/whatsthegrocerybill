...
function NewsEmailBanner() {
  ...
  if (status === 'done') return (
    <div style={{ marginBottom: 32, padding: '18px 20px', background: 'rgba(34,197,94,0.07)', border: '1px solid rgba(34,197,94,0.2)', borderRadius: 12, fontSize: 14, color: 'var(--green)', fontWeight: 600 }}>
    ...
    <div style={{ marginBottom: 32, padding: '20px', background: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 12 }}>
      ...
      <form onSubmit={async e => {
        ...
        <input
          ...
          style={{ padding: '12px 16px', borderRadius: 10, border: '1px solid var(--border)', background: '#f8fafc', color: 'var(--text)', fontSize: 15, width: '100%', boxSizing: 'border-box', outline: 'none' }}
        />
      ...
      {status === 'error' && <div style={{ fontSize: 12, color: 'var(--red)', marginTop: 8 }}>Something went wrong — try again.</div>}
    </div>
  )
}
            ...
            {articles.map((article, i) => (
              ...
              >
                ...
                >
                  ...
                  {/* Subhead */}
                  <p style={{
                    margin: 0, fontSize: 14, color: 'var(--muted)', lineHeight: 1.5,
                  }}>{article.subhead}</p>
